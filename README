...
The purpose of this fork is to experiment with an alternate adaptive priority based scheduler in xv6.
...
Once booted, you will be dropped into a simple shell. Run ls to see available files and programs. To exit QEMU: Press Ctrl-a then x.
